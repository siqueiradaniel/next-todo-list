...
export default function Login() {
    ...
    const { client, register } = useClientsContext()
    ...
    return (
        <div className="min-h-screen w-full bg-cyan-600 flex items-center justify-center">
            <div className="h-full max-w-xs md:min-w-md flex flex-col gap-3 bg-gray-100 p-8 rounded-2xl text-gray-600">
                <h1 className="text-4xl text-gray-950 font-extrabold">Create user</h1>
                ...
                <button>
                    <span className="text-xl font-semibold" onClick={() => router.push('/login')}>
                        or, log in
                    </span>
                </button>
            </div>
